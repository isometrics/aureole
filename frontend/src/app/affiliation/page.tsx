      ...
      <div className="flex-1 px-4 pb-4 overflow-hidden">
        <div className="flex h-full overflow-hidden">
          ...
          <div className="bg-[#1D1D1D] rounded-r-2xl flex-1 shadow-sm overflow-hidden">
            {/* Affiliation Content */}
            <div className="p-8">
              <h1 className="text-3xl font-bold text-white mb-6">Affiliation Analysis</h1>
                ...
                <div className="bg-[#292929] rounded-lg p-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-purple-400 font-semibold">654</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-400">Amazon</span>
                      <span className="text-yellow-400 font-semibold">432</span>
                    </div>
                  </div>
                </div>
                
                <div className="bg-[#292929] rounded-lg p-6">
                  <h3 className="text-lg font-semibold text-white mb-4">Affiliation Types</h3>
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
              ...
              <div className="bg-[#292929] rounded-lg p-6">
                <h2 className="text-2xl font-bold text-white mb-4">Affiliation Details</h2>
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-[#1D1D1D] rounded-lg">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="text-white font-medium">Microsoft Corporation</p>
                        <p className="text-gray-400 text-sm">1,247 contributors • 45 repositories</p>
                      </div>
                    </div>
                    <span className="text-blue-400 text-sm">Corporate</span>
                  </div>
                  <div className="flex items-center justify-between p-4 bg-[#1D1D1D] rounded-lg">
                    <div className="flex items-center gap-4">
                      <div className="w-10 h-10 bg-green-500 rounded-full flex items-center justify-center text-white font-semibold">G</div>
                      <div>
                        <p className="text-white font-medium">Google LLC</p>
                        <p className="text-gray-400 text-sm">892 contributors • 32 repositories</p>
                      </div>
                    </div>
                    <span className="text-green-400 text-sm">Corporate</span>
                  </div>
                  <div className="flex items-center justify-between p-4 bg-[#1D1D1D] rounded-lg">
                    <div className="flex items-center gap-4">
                      <div className="w-10 h-10 bg-purple-500 rounded-full flex items-center justify-center text-white font-semibold">M</div>
                      <div>
                        <p className="text-white font-medium">Meta Platforms</p>
                        <p className="text-gray-400 text-sm">654 contributors • 28 repositories</p>
                      </div>
                    </div>
                    <span className="text-purple-400 text-sm">Corporate</span>
                  </div>
                </div>
              </div>
            </div>
