...
export default function Sidebar({ 
  ...
  useEffect(() => {
    ...
    <div className="flex flex-col h-full">
      ...
      {currentTitle === "8Knot" && !isCollapsed && (
        // 8Knot navigation content
        <div className="flex-1 p-4">
          <div className="space-y-2">
            <h3 className="text-lg font-semibold text-white mb-4 px-2">8Knot Navigation</h3>
            
            <a 
              href="/repo_overview" 
              className="flex items-center gap-3 px-3 py-2 text-gray-300 hover:text-white hover:bg-[#404040] rounded-lg transition-colors duration-150"
            >
